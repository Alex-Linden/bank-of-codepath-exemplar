...
export function testNavbar(App) {
  ...
  FeatureTestSuite.after((ctx) => {
    ...
    // console.log(workerWithRequests.getRequestsByFileSummary())
    // console.log({ workerWithRequests })
  })
  ...
  FeatureTestSuite.test("The Navbar.jsx component should receive the correct props", async (ctx) => {
    ...
    // ctx.testInstances.propAssertions.Navbar.assertComponentExistsAndHasValueInProps("handleOnInputChange")
    ...
    // ctx.testInstances.propAssertions.Navbar.assertComponentExistsAndHasPropOfType("handleOnInputChange", "function")
